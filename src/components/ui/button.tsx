 ...
 */
const base =
  "group/button inline-flex items-center justify-center gap-2 rounded-full font-medium " +
...
const variants: Record<Variant, string> = {
  ...
  glass: "glass-panel text-white hover:brightness-125 hover:border-white/25",
};
